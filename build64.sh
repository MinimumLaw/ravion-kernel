...
export DTBS="${DTBS} ravion/imx8mq-rhos-kitsbimx8.dtb	ravion/rk3568-rhos-kitsbimx8.dtb"
export DTBS="${DTBS} ravion/imx8mq-rhos-pkk.dtb		rockchip/rk3568-roc-pc.dtb"
