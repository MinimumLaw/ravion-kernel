...
export DEF_TARGET="zImage modules imx6dl-colibri-mcp.dtb imx6dl-colibri-mcp-maximal.dtb imx6dl-colibri-cimc-lite.dtb imx6dl-colibri-cimc.dtb imx6dl-colibri-mtu.dtb"
