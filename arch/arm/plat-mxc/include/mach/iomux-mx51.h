...
#define MX51_CSPI_PAD_CTRL	(PAD_CTL_DSE_HIGH | PAD_CTL_PKE | PAD_CTL_SRE_FAST)
...
#define MX51_PAD_CTRL_14	(PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE)
#define MX51_SDHC_PAD_CTRL 	(PAD_CTL_PKE | PAD_CTL_PUE | \
...
#define MX51_PAD_EIM_D23__GPIO_2_7	IOMUX_PAD(0x40c, 0x078, IOMUX_CONFIG_ALT1 | IOMUX_CONFIG_SION,  \
										0x0, 0, MX51_PAD_CTRL_7)

/* UART3 */
#define MX51_PAD_EIM_D24__UART3_CTS	IOMUX_PAD(0x410, 0x07c, IOMUX_CONFIG_ALT3, 0x0, 0, MX51_UART3_PAD_CTRL)
#define MX51_PAD_EIM_D25__UART3_RXD	IOMUX_PAD(0x414, 0x080, IOMUX_CONFIG_ALT3, 0x9f4, 0x00, MX51_UART3_PAD_CTRL)
#define MX51_PAD_EIM_D26__UART3_TXD	IOMUX_PAD(0x418, 0x084, IOMUX_CONFIG_ALT3, 0x0, 0, MX51_UART3_PAD_CTRL)
#define MX51_PAD_EIM_D27__UART3_RTS	IOMUX_PAD(0x41c, 0x088, IOMUX_CONFIG_ALT3, 0x9f0, 0x03, MX51_UART3_PAD_CTRL)
...
#define MX51_PAD_EIM_A16__GPIO_2_10	IOMUX_PAD(0x430, 0x09c, IOMUX_CONFIG_ALT1 | IOMUX_CONFIG_SION, 0x0,   0, NO_PAD_CTRL)
...
#define MX51_PAD_EIM_A21__GPIO_2_15	IOMUX_PAD(0x444, 0x0b0, IOMUX_CONFIG_ALT1 | IOMUX_CONFIG_SION, 0x0,   0, NO_PAD_CTRL)
#define MX51_PAD_EIM_A22__GPIO_2_16	IOMUX_PAD(0x448, 0x0b4, IOMUX_CONFIG_ALT1 | IOMUX_CONFIG_SION, 0x0,   0, NO_PAD_CTRL)
...
#define MX51_PAD_EIM_A25__GPIO_2_19	IOMUX_PAD(0x454, 0x0c0, 1, 0x0,   0, MX51_GPIO_PAD_CTRL)
#define MX51_PAD_EIM_A26__GPIO_2_20	IOMUX_PAD(0x458, 0x0c4, 1, 0x0,   0, MX51_GPIO_PAD_CTRL)
#define MX51_PAD_EIM_A26__CAN_IRQ	IOMUX_PAD(0x458, 0x0c4, 1, 0x0,   0, MX51_PAD_CTRL_14)
...
#define MX51_PAD_EIM_LBA__LBA		IOMUX_PAD(0x494, 0xFC, 0, 0x0, 0, NO_PAD_CTRL)
...
/* FEC */
#define MX51_PAD_EIM_EB2__FEC_MDIO	IOMUX_PAD(0x468, 0x0d4, 3, 0x0,   0, MX51_PAD_CTRL_1 | PAD_CTL_PUS_22K_UP | PAD_CTL_ODE)
...
#define MX51_PAD_NANDF_RB2__FEC_COL	IOMUX_PAD(0x500, 0x124, 1, 0x0, 0, MX51_PAD_CTRL_4)
#define MX51_PAD_NANDF_RB3__FEC_RXCLK	IOMUX_PAD(0x504, 0x128, 1, 0x0, 0, MX51_PAD_CTRL_4)
...
#define MX51_PAD_NANDF_D8__FEC_TDAT0	IOMUX_PAD(0x558, 0x170, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_NANDF_D9__FEC_RDAT0	IOMUX_PAD(0x554, 0x16C, 2, 0x0, 0, MX51_PAD_CTRL_4)
#define MX51_PAD_NANDF_D11__RX_DV	IOMUX_PAD(0x54C, 0x164, 2, 0x0, 0, MX51_PAD_CTRL_4)

#define MX51_PAD_NANDF_D15__GPIO_3_25	IOMUX_PAD(0x53C, 0x154, 3, 0x0, 0, NO_PAD_CTRL)
#define MX51_PAD_NANDF_D14__GPIO_3_26	IOMUX_PAD(0x540, 0x158, 3, 0x0, 0, MX51_GPIO_PAD_CTRL)
...
#define MX51_PAD_CSI2_D19__GPIO_4_12		IOMUX_PAD(0x5D8, 0x1E8, IOMUX_CONFIG_ALT3 | IOMUX_CONFIG_SION, \
											0x0, 0, MX51_PAD_CTRL_12)
...
#define MX51_PAD_CSI2_PIXCLK__GPIO_4_15		IOMUX_PAD(0x5E4, 0x1F4, IOMUX_CONFIG_ALT3 | IOMUX_CONFIG_SION, \
											0x0, 0, NO_PAD_CTRL)
...
#define MX51_PAD_DI1_PIN11__CSPI1_SS2		IOMUX_PAD(0x6A8, 0x2A8, 7, 0x0, 0, MX51_PAD_CTRL_11)
...
/* UART1 in DTE mode */
#define MX51_PAD_UART1_RXD__UART1_RXD_DTE_MODE	IOMUX_PAD(0x618, 0x228,	IOMUX_CONFIG_ALT0, 0x9e4, 1, MX51_UART1_PAD_CTRL | PAD_CTL_SRE_FAST)
#define MX51_PAD_UART1_TXD__UART1_TXD_DTE_MODE	IOMUX_PAD(0x61C, 0x22C, IOMUX_CONFIG_ALT0, 0x0, 0, MX51_UART1_PAD_CTRL | PAD_CTL_SRE_FAST)
#define MX51_PAD_UART1_RTS__UART1_RTS_DTE_MODE	IOMUX_PAD(0x620, 0x230, IOMUX_CONFIG_ALT0, 0x9e0, 1, MX51_UART1_PAD_CTRL)
#define MX51_PAD_UART1_CTS__UART1_CTS_DTE_MODE	IOMUX_PAD(0x624, 0x234, IOMUX_CONFIG_ALT0, 0x0, 0, MX51_UART1_PAD_CTRL)
#define MX51_PAD_UART3_RXD__UART1_DTR_DTE_MODE	IOMUX_PAD(0x630, 0x240, IOMUX_CONFIG_ALT0, 0x0, 0, MX51_UART1_PAD_CTRL)
#define MX51_PAD_UART3_TXD__UART1_DSR_DTE_MODE	IOMUX_PAD(0x634, 0x244, IOMUX_CONFIG_ALT0, 0x0, 0, MX51_UART1_PAD_CTRL)
#define MX51_PAD_KEY_COL4__UART1_RI_DTE_MODE	IOMUX_PAD(0x65C, 0x26C, IOMUX_CONFIG_ALT1, 0x0, 0, MX51_UART1_PAD_CTRL)
#define MX51_PAD_KEY_COL5__UART1_DCD_DTE_MODE	IOMUX_PAD(0x660, 0x270, IOMUX_CONFIG_ALT1, 0x0, 0, MX51_UART1_PAD_CTRL)
...
/* UART1 for TSVS */
#define MX51_PAD_KEY_COL4__UART1_RI		IOMUX_PAD(0x65C, 0x26C, IOMUX_CONFIG_ALT1, 0x0,   0, MX51_UART1_PAD_CTRL)
#define MX51_PAD_KEY_COL5__UART1_DCD		IOMUX_PAD(0x660, 0x270, IOMUX_CONFIG_ALT1, 0x0,   0, MX51_UART1_PAD_CTRL)
...
/* CSPI */
#define MX51_PAD_SD2_CMD__CSPI_MOSI	IOMUX_PAD(0x7BC, 0x3B4, IOMUX_CONFIG_ALT2, 0x91C, 0x03, MX51_CSPI_PAD_CTRL)
#define MX51_PAD_SD2_CLK__CSPI_CLK	IOMUX_PAD(0x7C0, 0x3B8, IOMUX_CONFIG_ALT2, 0x914, 0x03, MX51_CSPI_PAD_CTRL)
#define MX51_PAD_SD2_DATA0__CSPI_MISO	IOMUX_PAD(0x7C4, 0x3BC, IOMUX_CONFIG_ALT2, 0x918, 0x03, MX51_CSPI_PAD_CTRL)
#define MX51_PAD_SD2_DATA3__CSPI_SS2	IOMUX_PAD(0x7D0, 0x3C8, IOMUX_CONFIG_ALT2, 0x924, 0x01, MX51_CSPI_PAD_CTRL)
...
#define MX51_PAD_GPIO_1_2__I2C2_SCL		IOMUX_PAD(0x7D4, 0x3CC, 2 | IOMUX_CONFIG_SION, 0x9b8, 3, MX51_I2C_PAD_CTRL)
