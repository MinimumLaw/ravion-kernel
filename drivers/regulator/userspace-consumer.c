...
#if defined(CONFIG_OF)
static const struct of_device_id reg_userspace_consumer_of_match[] = {
	{ .compatible = "reg-userspace-consumer", },
	{},
};
MODULE_DEVICE_TABLE(of, reg_userspace_consumer_of_match);
#endif
...
static struct platform_driver regulator_userspace_consumer_driver = {
	...
	.driver		= {
		...
		.of_match_table = of_match_ptr(reg_userspace_consumer_of_match),
	},
};
